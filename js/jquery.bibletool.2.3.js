...
(function($){
	...
	build_mask = function(){
		var obj = {'class': ($Mask.split('.').pop()),style:{position:'absolute',top:'0px',left:'0px',width:($(document).width())+'px',height:($(document).height())+'px','background-color':'#888888',opacity:.5,filter:'alpha(Opacity=50)'}};
		return tag('div',obj);
	},
